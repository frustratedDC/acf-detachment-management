...
const NAV_GROUPS = [
  ...
  // ── 5. Training ──────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { path: '/attendance',           label: 'Lesson Nominal Roll',  icon: FileCheck,      level: 3 },
      { path: '/schedule',             label: 'Training Plan',        icon: Calendar,       level: 2 },
      { path: '/training-manager',     label: 'Training Manager',     icon: Brain,          level: 4 },
      { path: '/community-engagement', label: 'CE / KA Session Entry',icon: Dumbbell,       level: 1 },
  ...
  // ── 6. Detachment ────────────────────────────────────────────────────────────
  {
    ...
    icon: MapPin,
    items: [
      { path: '/analytics',       label: 'Analytics',            icon: BarChart2,  level: 5 },
      { path: '/monthly-reports', label: 'Monthly Reports',      icon: FileText,   level: 5 },
  ...
  // ── System Admin ─────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { path: '/project-board', label: 'Project Board', icon: Layers, level: 6 },
    ],
  },
];
