...
const NAV_GROUPS = [
  ...
  // ── 4. CFAVs ─────────────────────────────────────────────────────────────────
  {
    ...
    icon: UsersRound,
    items: [
      { path: '/personnel',        label: 'CFAV Nominal Roll',     icon: UserCog,       level: 2, cfavOnly: true },
      { path: '/instructor-quals', label: 'CFAV Qualifications',   icon: BadgeCheck,    level: 3 },
      { path: '/cfav-governance',  label: 'CFAV Governance',       icon: ShieldCheck,   level: 2 },
      { path: '/all-availability', label: 'CFAV Availability',     icon: CalendarCheck, level: 2 },
      { path: '/admin',            label: 'CFAV Discipline Log',   icon: Swords,        level: 5 },
      { path: '/my-governance',    label: 'CFAV Uniform Requests', icon: Shirt,         level: 2, cfavOnly: true },
      { path: '/course-request',   label: 'CFAV Course Requests',  icon: BookOpen,      level: 2, cfavOnly: true },
      { path: '/report-issue',     label: 'CFAV Issues Log',       icon: AlertCircle,   level: 2, cfavOnly: true },
    ],
  },
